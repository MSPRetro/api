...
const { trustpilotEmail } = require("../config.json");
...
exports.run = async (req, res) => {
  ...
  try {
    event = stripe.webhooks.constructEvent(req.body, signature, process.env.StripeWebhook);
  } catch (err) {
